    ...
    def readData(self):
        ...
        for i in range(1,rows_count):   #循环遍历表数据
            ...
            for testcase in testcases:
                testcase.case_priority = self.excelanswerdata.get_answer_comments(i)  #保存answer_comments
                testcase.save()   #保存到数据库


if __name__ == "__main__":
    readdata = ReadData(file_name=r"D:\Users\Administrator\PycharmProjects\yiniceshi\db_tools\data\exceldata\casepriority.xls")  #实例化
    readdata.readData()
